...
public class ProductService : IProductService
{
	...
	public async Task<QueryResult<Product>> ListAsync(ProductsQuery query)
	{
		...
		var cacheKey = GetCacheKeyForProductsQuery(query);
	...
	private string GetCacheKeyForProductsQuery(ProductsQuery query) => $"{CacheKeys.ProductsList}_{query.CategoryId}_{query.Page}_{query.ItemsPerPage}";
}