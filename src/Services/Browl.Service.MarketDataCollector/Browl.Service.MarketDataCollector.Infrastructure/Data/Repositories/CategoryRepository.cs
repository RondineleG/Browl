...
namespace Browl.Service.MarketDataCollector.Infrastructure.Data.Repositories
{
	public class CategoryRepository : BaseRepository, ICategoryRepository
	{
		...
		{
			return await _browlDbContext.Categories.AsNoTracking().ToListAsync();
		}

		public async Task AddAsync(Category category)
		{
			_ = await _browlDbContext.Categories.AddAsync(category);
		}

		public async Task<Category> FindByIdAsync(int id)
		{
			return await _browlDbContext.Categories.FindAsync(id);
		}

		public void Update(Category category)
		{
			_ = _browlDbContext.Categories.Update(category);
		}

		public void Remove(Category category)
		{
			_ = _browlDbContext.Categories.Remove(category);
		}
	}
}