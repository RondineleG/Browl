...
public class AuthControllerTest
{
	...
	public AuthControllerTest()
	{
		...
		_ = _appSettings.Value.Returns(new AppSettings());
	...
	public async Task Register_IsValidModel_ReturnsOkResult()
	{
		...
		_ = _userManager.CreateAsync(Arg.Any<IdentityUser>(), Arg.Any<string>())
		...
		_ = okResult.Value.Should().BeAssignableTo<UserResponse>().Subject;
